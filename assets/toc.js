...
(function($){
  $.fn.toc = function(options) {
    var defaults = {
      ...
      title: '<h3>目录</h3><button onclick="toggleSize()">点击我</button>',
    ...
    function toggleSize() { //点击缩小 还原
      var div = document.querySelector('.floating-div');
      if (div.style.width === '200px' && div.style.height === '500px') {
